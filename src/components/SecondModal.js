      ...
      <div className="modal-content">
        {IsEntryCreated ? (
          ...
          <>
            ...
            <input type="text" placeholder="Your company" value={company} onChange={handleCompanyChange}></input>
            <input type="text" placeholder="Why do you want a group masterclass at your company?" value={reason} onChange={handleReasonChange}></input>
